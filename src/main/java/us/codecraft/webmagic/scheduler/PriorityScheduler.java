...
public class PriorityScheduler extends DuplicateRemovedScheduler implements MonitorableScheduler {
    ...
    public PriorityScheduler(int capacity){
    	priorityQueuePlus = new PriorityBlockingQueue<Request>(capacity, new Comparator<Request>() {
            @Override
        ...
        priorityQueueMinus = new PriorityBlockingQueue<Request>(capacity, new Comparator<Request>() {
            @Override
            public int compare(Request o1, Request o2) {
                return -NumberUtils.compareLong(o1.getPriority(), o2.getPriority());
            }
